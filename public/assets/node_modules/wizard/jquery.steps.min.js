...
! function(a, b) {
    ...
    function E(b, c, d, e) {
        ...
        f.prepend(g).parent()._selectAria().removeClass("done")._enableAria(), h.eq(d.currentIndex).next(".body");
    }
    ...
    function L(a, b, c) {
        if (b.enablePagination) {
            var d = '<{0} class="actions {1}"><ul role="menu" aria-label="{2}">{3}</ul></{0}>',
                e = '<li><a href="#{0}" onclick="return validate_page()" role="menuitem">{1}</a></li>',
                f = "";
