 ...
 * authorized to uploads and access files in the File Browser.
 *
 * @return boolean
 */
function CheckAuthentication()
{
	...
	// "anyone" to uploads and list the files in your server. You must implement
...
$baseUrl = 'http://'.$_SERVER['SERVER_NAME'].'/uploads/userfiles/';
...
//$baseDir = resolveUrl($baseUrl);
$baseDir = $_SERVER['DOCUMENT_ROOT'].'/uploads/userfiles/';
...
/*
For example, if you want to restrict the uploads, rename or delete of files in
...
to uploads `.swf` files only if you understand and can accept this risk.
==============================================================================
*/
...
/*
 ...
 How does it work? Suppose the following:
	...
	- If "php" is on the denied extensions list, a file named foo.php cannot be
	  uploaded.
	- If "rar" (or any other) extension is allowed, one can uploads a file named
	  foo.rar.
