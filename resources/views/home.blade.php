    ...
    @if(isset($categoryDetail) && count($categoryDetail) > 0)
        @foreach($categoryDetail as $key => $category)
            @if(isset($category['products']) && count($category['products']) > 0)
                <section class="section featured-venues latest-news" style="{{ ($key == 0) ? '' : 'padding-top: 0px' }} ">
                    <div class="container">
                        <div class="section-heading aos" data-aos="fade-up">
                            <h2>Latest Used <span>{{ $category['category_title'] }} Machines</span></h2>
                        </div>
                        <div class="row mb-5">
                                        ...
                                        <div class="listing-item listing-item-grid mb-0 h-100 d-flex flex-column" style="background: #fff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 20px rgba(0,0,0,0.06); transition: 0.3s; border: 1px solid #f0f0f0;">
                                            <div class="listing-img" style="position: relative; height: 200px; overflow: hidden;">
                                                ...
                                                <a href="{{ url('machines/' . $product['product_slug']) }}" class="h-100 w-100 d-block">
                                                    @if(isset($product['pimages']) && count($product['pimages']) > 0)
                                            ...
                                            <div class="listing-content d-flex flex-column flex-grow-1" style="padding: 20px;">
                                                ...
                                                <div class="listing-details-group d-flex justify-content-between align-items-center mb-3">
                                                    ...
                                                    <div class="white-bg d-flex align-items-center review shadow-sm py-1 px-2 border rounded">
                                                        ...
                                                        <span class="text-dark fw-bold" style="font-size: 12px;">{{ isset($product['city']['city_name']) ? $product['city']['city_name'] : 'N/A' }}</span>
                                                    </div>
                                                </div>
                        ...
                        <div class="view-all text-center aos" data-aos="fade-up">
                            <a href="{{ url('/machines?category=' . $category['category_slug']) }}" class="btn btn-secondary d-inline-flex align-items-center">View All {{ $category['category_title'] }} <span class="lh-1"><i class="feather-arrow-right-circle ms-2"></i></span></a>
                        </div>
                        <!-- View More -->
                    </div>
                </section>
