    ...
    <script type="text/javascript">
        ...
        $('#myTable1').DataTable({
            ...
            columns: [
                ...
                { data: 'login_date', name: 'login_date', orderable: false, searchable: false },
                { data: 'ip', name: 'ip', orderable: false, searchable: false },
                { data: 'membership', orderable: false, searchable: false, className: 'text-center' },
        ...
        function change_status(customer_id, status) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (status == 1){
                        $("#td_status_"+customer_id).html("<a href=\"javascript:void(0)\" onclick=\"change_status('"+customer_id+"', '0')\" ><div class=\"label label-table label-success\">Active</div></a>");
                    } else {
                        $("#td_status_"+customer_id).html("<a href=\"javascript:void(0)\" onclick=\"change_status('"+customer_id+"', '1')\" ><div class=\"label label-table label-danger\">Inactive</div></a>");
                    }
                }
            });
        }
