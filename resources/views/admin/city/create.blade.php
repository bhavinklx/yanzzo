...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="cityFrm" method="post" action="{{ route("city-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="card">
                                                <div class="row m-t-20">
                                                    <div class="form-group col-md-6 m-b-40" id="c_title">
                                                        <input type="text" class="form-control" name="city_title" id="city_title">
                                                        <span class="bar"></span>
                                                        <label for="city_title">City Title</label>
                                                        <span class="help-block"><small id="msg_city_title" class="text-danger"></small></span>
                                                    </div>

                                                    <div class="form-group col-md-6 m-b-40" id="c_slug">
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40">
                                                        <textarea class="form-control" name="city_short_desc" id="city_short_desc"></textarea>
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40 m-t-20">
                                                        <input class="form-control" name="city_meta_title" id="city_meta_title">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" class="dropify" data-default-file="" id="city_image" name="city_image" aria-describedby="fileHelp">
                                                        {{--<span style="color: red;font-size: 12px;">Best size: (Width:1920px X Height:720px)</span>--}}
                                                    </div>

                                                    <div class="col-md-6">
                                                        <div class="form-group col-md-12 m-b-40">
                                                            <textarea class="form-control" name="city_meta_keyword" id="city_meta_keyword"></textarea>
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-md-12 m-b-40">
                                                            <textarea class="form-control" name="city_meta_desc" id="city_meta_desc"></textarea>
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-md-12 m-b-40">
                                                            <input class="form-control" name="city_canonical" id="city_canonical">
                                                            <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea id="city_desc" name="city_desc"></textarea>
