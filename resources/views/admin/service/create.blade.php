...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="serviceFrm" method="post" action="{{ route("service-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                            ...
                                            <div class="card">
                                                <div class="row m-t-20">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" class="dropify" data-default-file="" id="service_image" name="service_image" aria-describedby="fileHelp">
