...
@section("content")
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="bannerFrm" action="{{ route("banner-insert") }}" method="post">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 m-t-25">
                                                        ...
                                                        <div class="form-group m-b-40" id="b_link">
                                                            <input type="text" class="form-control" name="banner_text" id="banner_text" >
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group m-b-40" id="b_link">
                                                            <input type="text" class="form-control" name="banner_text1" id="banner_text1" >
                                                            <span class="bar"></span>
                                                    ...
                                                    <div class="col-md-6 m-t-15">
                                                        <div class="row m-b-40">
                                                            <div class="col-md-6">
                                                                ...
                                                                <input type="file" class="dropify" data-default-file="" id="banner_image" name="banner_image" aria-describedby="fileHelp">
                                                                <span style="color: red;font-size: 12px;">Best size: (Width:1920px X Height:800px)</span>
                                                            </div>
                                                            <div class="col-md-6">
                                                                <label>Banner Icon</label><br><br>
                                                                <input type="file" class="dropify" data-default-file="" id="banner_icon" name="banner_icon" aria-describedby="fileHelp">
