...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="discountFrm" method="post" action="{{ route("discount-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                            ...
                                            <div class="card">
                                                <div class="row m-t-20">
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40" id="d_code">
                                                        <input type="text" class="form-control"  name="discount_code" id="discount_code" onkeyup="this.value = this.value.toUpperCase();">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40" id="d_amount">
                                                        <input type="text" class="form-control" name="discount_amount" id="discount_amount" onkeypress="return isNumberKey(event, this)">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-40 dob" id="d_sdate" >
                                                        <input type="text" class="form-control sdate" id="discount_start_date" name="discount_start_date" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-40" id="d_stime">
                                                        <input class="form-control" type="time" id="discount_start_time" name="discount_start_time" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-20 dob" id="d_edate" >
                                                        <input type="text" class="form-control sdate" id="discount_end_date" name="discount_end_date" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-40" id="d_etime">
                                                        <input class="form-control" type="time" id="discount_end_time" name="discount_end_time" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40" id="d_minamount">
                                                        <input type="text" class="form-control isNumber" name="discount_min_amount" id="discount_min_amount" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40" id="d_maxamount">
                                                        <input type="text" class="form-control isNumber" name="discount_max_discount" id="discount_max_discount" >
                                                        <span class="bar"></span>
