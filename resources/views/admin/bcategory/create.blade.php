...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="bcategoryFrm" method="post" action="{{ route("bcategory-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                                ...
                                                <div class="card">
                                                    <div class="row card-body m-t-20">
                                                        ...
                                                        <div class="form-group col-lg-6 m-b-40" id="b_title">
                                                            <input type="text" class="form-control" name="bcategory_title" id="bcategory_title" >
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-lg-6 m-b-40" id="b_slug">
                                                            <input type="text" class="form-control" id="bcategory_slug" name="bcategory_slug" >
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-lg-6 m-b-40">
                                                            <input type="text" class="form-control" name="bcategory_meta_title" id="bcategory_meta_title" >
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-lg-6 m-b-40">
                                                            <input type="text" class="form-control" name="bcategory_meta_keyword" id="bcategory_meta_keyword">
                                                            <span class="bar"></span>
                                                        ...
                                                        <div class="form-group col-lg-6">
                                                            <textarea class="form-control" name="bcategory_meta_desc" id="bcategory_meta_desc"></textarea>
                                                            <span class="bar"></span>
