...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="membershipFrm" method="post" action="{{ route("membership-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                            ...
                                            <div class="card">
                                                <div class="row m-t-20">
                                                    <div class="form-group col-md-6 m-b-40" id="m_title">
                                                        <input type="text" class="form-control" name="membership_title" id="membership_title">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-6 m-b-40" id="m_slug">
                                                        <input type="text" class="form-control" id="membership_slug" name="membership_slug">
                                                        <span class="bar"></span>
                                                        <label for="membership_slug">Membership Slug <span class="form-asterisk">*</span></label>
                                                        <span class="help-block"><small id="msg_membership_slug" class="text-danger"></small></span>
                                                    </div>

                                                    <div class="form-group col-md-3 m-b-40">
                                                        <input class="form-control isNumber" name="membership_price" id="membership_price">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-40">
                                                        <input class="form-control isNumber" name="membership_offer_price" id="membership_offer_price">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-3 m-b-40" id="m_slug">
                                                        <input type="text" class="form-control isNumber" id="membership_discount" name="membership_discount">
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea id="membership_desc" name="membership_desc"></textarea>
