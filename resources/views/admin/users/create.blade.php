...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form id="userFrm" class="floating-labels" method="post" action="{{ route("user-insert") }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group m-b-40" id="a_mobile">
                                                            <input type="text" class="form-control isNumber" name="phone" id="phone">
                                                            <span class="bar"></span>
                                                            <label for="phone">Mobile</label>
                                                            <span class="help-block"><small id="msg_phone" class="text-danger"></small></span>
                                                        </div>

                                                        <div class="form-group m-b-40" id="a_pass">
                                                    ...
                                                    <div class="col-lg-6 m-t-15">
                                                        ...
                                                        <div class="form-group m-b-40" id="a_cpass">
                                                    ...
                                                    <div class="form-group col-md-6" id="a_country">
                                                        <select class="select2 form-control" id="roles" name="roles[]">
                                                            ...
                                                            <?php if (is_array($roleDetail) && count($roleDetail)>0) { foreach ($roleDetail as $role) { ?>
