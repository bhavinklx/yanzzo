...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
                ...
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">FAQ Blog</li>
                        </ol>
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="faqFrm" method="post" action="{{ route("faq-update") }}">
                <input type="hidden" name="faq_id" value="{{ $faqDetail->faq_id }}">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                            ...
                                            <div class="card">
                                                <div class="row m-t-20">
                                                    {{--@php
                                                        $cityIdArray = [];
                                                    @endphp
                                                    @if(isset($faqDetail->city_id) && $faqDetail->city_id!='')
                                                        @php
                                                            $cityIdArray = explode(',', $faqDetail->city_id);
                                                        @endphp
                                                    @endif
                                                    ...
                                                    <div class="form-group col-md-12 m-b-40" id="f_title">
                                                        <input type="text" class="form-control" name="faq_title" id="faq_title" value="{{ $faqDetail->faq_title }}" >
                                                        <span class="bar"></span>
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <textarea id="faq_desc" name="faq_desc">{{ $faqDetail->faq_desc }}</textarea>
                                                        <script>
