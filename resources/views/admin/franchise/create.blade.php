        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="floating-labels" id="franchiseFrm" method="post" action="{{ route("franchise-insert") }}">
                        {{ csrf_field() }}
                                        ...
                                        <div class="card-body">
                                            <div class="row m-t-20">
                                                <div class="form-group col-md-6 m-b-40">
                                                    <input type="text" class="form-control" id="franchise_company_name" name="franchise_company_name">
                                                    <span class="bar"></span>
                                                    <label for="franchise_company_name">Company Name <span class="form-asterisk">*</span></label>
                                                ...
                                                <div class="form-group col-md-6 m-b-40 m-t-5">
                                                    <input type="text" class="form-control" name="franchise_owner_name" id="franchise_owner_name">
                                                    <span class="bar"></span>
                                                    <label for="franchise_owner_name">Contact Person <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_owner_name" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control" name="franchise_email" id="franchise_email">
                                                    <span class="bar"></span>
                                                    <label for="franchise_email">Email <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_email" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control isNumber" name="franchise_mobile1" id="franchise_mobile1" maxlength="10">
                                                    <span class="bar"></span>
                                                    <label for="franchise_mobile1">Mobile 1 <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_mobile1" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control isNumber" name="franchise_mobile2" id="franchise_mobile2" maxlength="10">
                                                    <span class="bar"></span>
                                                ...
                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control isNumber" name="franchise_mobile3" id="franchise_mobile3" maxlength="10">
                                                    <span class="bar"></span>
                                                ...
                                                <div class="form-group col-md-12 m-b-40">
                                                    <textarea class="form-control" name="franchise_address" id="franchise_address"></textarea>
                                                    <span class="bar"></span>
                                                    <label for="franchise_address">Office Address <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_address" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-6" id="a_email">
                                                ...
                                                <div class="form-group col-md-6" id="a_pass">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <div class="row m-t-20">
                                                <div class="form-group col-md-6 m-b-40">
                                                    <input class="form-control" name="franchise_pan" id="franchise_pan" maxlength="10">
                                                    <span class="bar"></span>
                                                    <label for="franchise_pan">PAN Card Number <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_pan" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control" name="franchise_gst" id="franchise_gst">
                                                    <span class="bar"></span>
                                                    <label for="franchise_gst">GST Number <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_gst" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3 m-b-40">
                                                    <input class="form-control isNumber" name="franchise_gst_percentage" id="franchise_gst_percentage">
                                                    <span class="bar"></span>
                                                ...
                                                <div class="form-group col-md-3">
                                                    <input class="form-control isNumber" name="franchise_bank_ac" id="franchise_bank_ac">
                                                    <span class="bar"></span>
                                                    <label for="franchise_bank_ac">Bank A/c Number <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_bank_ac" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <input class="form-control" name="franchise_bank_name" id="franchise_bank_name">
                                                    <span class="bar"></span>
                                                    <label for="franchise_bank_name">Bank Name <span class="form-asterisk">*</span></label>
                                                    <span class="help-block"><small id="msg_franchise_bank_name" class="text-danger"></small></span>
                                                </div>

                                                <div class="form-group col-md-3">
                                                    <input class="form-control" name="franchise_bank_ifsc" id="franchise_bank_ifsc">
                                                    <span class="bar"></span>
                                                    <label for="franchise_bank_ifsc">Bank IFSC <span class="form-asterisk">*</span></label>
                                                ...
                                                <div class="form-group col-md-3 m-t-5">
                                                    ...
                                                    <span class="bar"></span>
                                                    <label for="franchise_bank_type">Account Type <span class="form-asterisk">*</span></label>
