...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Start Page Content -->
            <form class="floating-labels" id="testimonialFrm" method="post" action="{{ route('testimonial-insert') }}" >
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                                                ...
                                                <div class="row card-body">
                                                    <div class="col-lg-6 m-t-40">
                                                        ...
                                                        <div class="form-group m-b-40">
                                                            <input type="text" class="form-control" name="testimonial_designation" id="testimonial_designation" >
                                                            <span class="bar"></span>
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="file" class="dropify" data-default-file="" id="testimonial_image" name="testimonial_image" aria-describedby="fileHelp">
                                                    </div>

                                                    <div class="form-group col-lg-12 m-b-40">
                                                        <label for="testimonial_desc" class="m-b-20" style="position: initial;">Description</label>
                                                        <textarea id="testimonial_desc" name="testimonial_desc"></textarea>
