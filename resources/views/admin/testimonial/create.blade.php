...
@section('content')
    ...
    <!-- App body starts -->
    <form id="testimonialFrm" method="post" action="{{ route('testimonial-insert') }}">
        {{ csrf_field() }}
        <div class="app-body">
            <!-- Row starts -->
            <div class="row gx-3">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-xxl-6 col-lg-4 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="testimonial_title" name="testimonial_title" placeholder="Enter Testimonial Title">
                                        ...
                                        <div class="col-xxl-6 col-lg-6 col-sm-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="testimonial_designation" name="testimonial_designation" placeholder="Enter Testimonial Designation">
