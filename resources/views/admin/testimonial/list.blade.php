                ...
                <div class="card">
                    <div class="card-header d-flex align-items-center justify-content-between">
                        ...
                        @if (auth()->user()->can('testimonial-add'))
                            <a href="{{ route("testimonial-add") }}" class="btn btn-primary ms-auto">Add Testimonial</a>
                        @endif
                    </div>
                    <div class="card-body">
                        <!-- Table starts -->
    ...
    <script type="text/javascript">
        ...
        var table = $('#basicExample').DataTable({
            ...
            columns: [
                ...
                { data: 'title', name: 'testimonial_title' },
        ...
        function change_status(testimonial_id, status) {
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (status == 1){
                        $("#td_status_"+testimonial_id).html("<a href=\"javascript:void(0)\" onclick=\"change_status('"+testimonial_id+"', '0')\" ><span class=\"badge bg-success\">Active</span></a>");
                    } else {
                        $("#td_status_"+testimonial_id).html("<a href=\"javascript:void(0)\" onclick=\"change_status('"+testimonial_id+"', '1')\" ><span class=\"badge bg-danger\">Inactive</span></a>");
                    }
                }
            });
        }
        ...
        function deleteData() {
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    /*$('#row_' + testimonial_id).remove();
                     setTimeout(function(){
                     location.reload();
                     },2000);*/
                    table.row($('#row_' + testimonial_id))
                            .remove()
                            .draw(false);
                }
            });
