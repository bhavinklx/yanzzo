        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-5 align-self-center">
                    <h4 class="text-themecolor">{{ ucwords($status) }} Membership</h4>
                </div>
                <div class="col-md-7 align-self-center text-right">
                    <div class="d-flex justify-content-end align-items-center">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ route("dashboard") }}">Home</a></li>
                            <li class="breadcrumb-item active">{{ ucwords($status) }} Membership List</li>
                        </ol>
...
@section('page-js')
    <script type="text/javascript">
        ...
        $('#myTable1').DataTable({
            ...
            paging: true,
            ajax: {
                url: '{{ route("membership-order-load-table") }}',
                type: 'GET',
                data: function (d) {
        ...
        function deleteData(msorder_id) {
            $.ajax({
                url: "{{ route('membership-order-delete') }}",
                type: "POST",
                data: {
                    msorder_id:msorder_id,
                    _token:'{{ csrf_token() }}'
                },
